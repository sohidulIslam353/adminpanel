(function($) {
  ...
  $(function() {
    ...
    setTimeout(function() {
      c3LineChart.on("unload", function() {
        ids: 'data1'
      });
    }, 2000);
    ...
    setTimeout(function() {
      c3DonutChart.on("unload", function() {
        ids: 'data1'
      });
      c3DonutChart.on("unload", function() {
        ids: 'data2'
